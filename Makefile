...
EXECUTABLE = \
	time_test_baseline time_test_monte time_test_machin time_test_openmp_2 time_test_openmp_4 \
	#time_test_avx time_test_avxunroll \
	benchmark_clock_gettime

default: computepi.o
	$(CC) $(CFLAGS) computepi.o time_test.c -DBASELINE -o time_test_baseline
	$(CC) $(CFLAGS) computepi.o time_test.c -DMONTE_CARLO -o time_test_monte
